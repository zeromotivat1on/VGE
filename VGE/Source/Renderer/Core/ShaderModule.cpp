...
{
	_DebugName = fmt::format("{} [variant {:X}] [entrypoint {}]", glslSource.GetFilename(), shaderVariant.GetId(), entryPoint);
	...
	if (!spirvReflection.reflect_shader_resources(stage, _Spirv, _Resources, shaderVariant))
	{
